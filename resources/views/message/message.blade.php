                            ...
                            <label for="message-sideSearch" class="form-label sideSearch-label">
                                <svg width="20" height="21" viewBox="0 0 20 21" fill="none"
                                    ...
                                    <path
                                        ...
                                        fill="#4B5675"></path>
                                    <path
                                        d="M18.3315 19.6249C18.1732 19.6249 18.0148 19.5666 17.8898 19.4416L15.1148 16.5499C14.8732 16.3082 14.8732 15.9082 15.1148 15.6665C15.3565 15.4249 15.7565 15.4249 15.9982 15.6665L18.7732 18.5582C19.0148 18.7999 19.0148 19.1999 18.7732 19.4416C18.6482 19.5666 18.4898 19.6249 18.3315 19.6249Z"
                                        fill="#4B5675"></path>
                                </svg>
                            </label>
