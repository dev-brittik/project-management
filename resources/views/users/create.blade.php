...
<div class="ol-card p-3">
    <div class="ol-card-body">
        <div class="row">
            <div class="col-6">
                <form action="{{ route('admin.user.store') }}" method="post" id="ajaxForm">@csrf
                    <div class="fpb7 mb-2">
                    ...
                    <div class="fpb7 mb-2">
                        ...
                        <input class="form-control ol-form-control" type="password" id="password" name="password"
                            required>
                    </div>
                    <div class="fpb-7 mb-3">
                        <label class="form-label ol-form-label" for="role_id">{{ 'User Type' }}</label>
                        <select class="form-control ol-form-control ol-select2" data-toggle="select2" name="role_id"
                            id="role_id" required>
