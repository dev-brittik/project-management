    ...
    <div class="ol-card-body">
        ...
        <div class="row mt-3 mb-4 print-d-none">
            <div class="col-md-6 d-flex align-items-center gap-3">
                ...
                <div class="">
                    <a href="#"
                        onclick="rightCanvas('{{ route(get_current_user_role() . '.invoice.create', ['code' => request()->route()->parameter('code')]) }}', 'Create Invoice')"
                            ...
                            <td>
                                <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                    <div class="dAdmin_profile_name">
                                        <h4 class="title fs-14px">{{ $payment->title }}</h4>
                                    </div>
                                </div>
                            </td>
                            <td>
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item"
                                                onclick="rightCanvas('{{ route(get_current_user_role() . '.invoice.edit', $payment->id) }}', 'Edit invoice')"
                                                href="#">{{ get_phrase('Edit') }}</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                onclick="confirmModal('{{ route(get_current_user_role() . '.invoice.delete', $payment->id) }}')"
        ...
        $(document).ready(function() {
            ...
            $('#delete-selected').click(function() {
                ...
                if (selectedIds.length > 0) {
                    ajaxCall("{{ route(get_current_user_role() . '.invoice.multi-delete') }}",
                        selectedIds);
