    ...
    <div class="ol-card-body">
        ...
        <div class="row mt-3 mb-4 print-d-none">
            <div class="col-md-6 d-flex align-items-center gap-3">
                ...
                <div class="">
                    <a href="#"
                        onclick="rightCanvas('{{ route(get_current_user_role() . '.timesheet.create', ['code' => request()->route()->parameter('code')]) }}', 'Timesheet')"
            ...
            <table class="table eTable eTable-2 " id="datatable">
                ...
                <tbody>
                    @foreach ($timesheets as $key => $timesheet)
                        <tr data-id="{{ $timesheet->id }}" class="context-menu">
                            ...
                            <td>
                                <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                    <div class="dAdmin_profile_name">
                                        <h4 class="title fs-14px">{{ $timesheet->title }}</h4>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                    <div class="dAdmin_profile_name">
                                        <h4 class="title fs-14px">{{ $timesheet->timestamp_start }}</h4>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="dAdmin_profile d-flex align-items-center min-w-200px">
                                    <div class="dAdmin_profile_name">
                                        <h4 class="title fs-14px">{{ $timesheet->timestamp_end }}</h4>
                                    </div>
                                </div>
                            </td>
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item"
                                                onclick="rightCanvas('{{ route(get_current_user_role() . '.timesheet.edit', $timesheet->id) }}', 'Edit timesheet')"
                                                href="#">{{ get_phrase('Edit') }}</a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item"
                                                onclick="confirmModal('{{ route(get_current_user_role() . '.timesheet.delete', $timesheet->id) }}')"
        ...
        $(document).ready(function() {
                ...
                items: {
                    Edit: {
                        ...
                        callback: function(itemKey, opt, e) {
                            ...
                            rightCanvas("{{ url(get_current_user_role() . 'timesheet/edit/') }}" +
                                '/' +
                                id,
                                'Edit timesheet')
                        }
                    ...
                    Delete: {
                        ...
                        callback: function(itemKey, opt, e) {
                            const id = opt.$trigger.attr("data-id");
                            confirmModal("{{ url(get_current_user_role() . 'timesheet/delete/') }}" +
                                '/' +
                                id)
                        }
                    }
            ...
            $('#delete-selected').click(function() {
                ...
                if (selectedIds.length > 0) {
                    ajaxCall("{{ route(get_current_user_role() . '.timesheet.multi-delete') }}",
                        selectedIds);
